    ...
    <>
      ...
      <Box
        ...
        <Box sx={{ display: "flex", justifyContent: "center", mt: "2rem" }}>
          <Button variant='contained' sx={{ mr: "20px", backgroundColor: "#A02322", fontFamily: "Lato", color: "#ffffff", '&:hover': { backgroundColor: "#881F1D", color: "#ffffff" } }}>Book Service</Button>
          <Button variant='contained' sx={{ backgroundColor: "#69903C", fontFamily: "Lato", color: "#ffffff", '&:hover': { backgroundColor: "#5A7A33", color: "#ffffff" } }}>Learn More</Button>
        </Box>
