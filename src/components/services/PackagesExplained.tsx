        ...
        <Grid container spacing={2} sx={{ pr: 4 }}>
          <Grid item md={4}>
            <Box sx={{ display: "flex", justifyContent: "center" }}>
              <Box component={"img"} src={press} sx={{ width: "50%", height: "auto" }} />
            </Box>
          </Grid>
          <Grid item md={8}>
            ...
            <br /><Typography><b>Orchard Service</b> is best suited for large scale apple pressing projects. You have more than 10 bushels of apples and pressing them all may take more than one day. Please contact us to discuss availability.</Typography>
            <br /><Typography><b>Neighborhood Service?</b></Typography>
          </Grid>
        </Grid>
      </Box>
    </>
